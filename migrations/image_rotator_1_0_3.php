...
class image_rotator_1_0_3 extends \phpbb\db\migration\migration
{
	...
	{
		return isset($this->config['image_rotator_version']) && version_compare($this->config['image_rotator_version'], '1.0.3', '>=');
	}
	...
	public function update_data()
	{
		return array(
			// Current version
			array('config.update', array('image_rotator_version', '1.0.3')),
		);
	}
}